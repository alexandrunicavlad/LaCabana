package com.xamarin.googleplayservices.maps.sample;
...
public class TrialSplashScreen extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreen.this, md53fd388ed257ece170a8fa9579f8e80c8.MainActivity.class);
