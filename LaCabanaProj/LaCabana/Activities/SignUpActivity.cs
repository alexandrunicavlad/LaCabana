...
namespace LaCabana
{
	...
	public class SignUpActivity : BaseDrawerActivity
	{
		...
		protected override void OnCreate(Bundle savedInstanceState)
		{
			...
			SetTitleActionBar(GetString(Resource.String.Signup));
		...
		private void RegisterLogin()
		{
			...
			{
				CreateDialog(GetString(Resource.String.enteremail), true);
				return;
			}
			else if (password.Text == "")
			{
				CreateDialog(GetString(Resource.String.enterpass), true);
				return;
			}
